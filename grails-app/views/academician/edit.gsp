...
<html>
	...
	<body>
		<div id="edit-academician" class="content scaffold-edit box box-primary" role="main">
			...
			<g:hasErrors bean="${academicianInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${academicianInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:academicianInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${academicianInstance?.version}" />
				<fieldset class="form">
